<nav class="navbar navbar-expand-md bg-primary " data-bs-theme="dark">
    <div class="container"><a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}"><span
                class="bs-icon-sm bs-icon-rounded bs-icon-semi-white d-flex justify-content-center align-items-center me-2 bs-icon"><svg
                    class="bi bi-brush" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                    viewBox="0 0 16 16">
                    <path
                ...
                </svg></span><span>{{ config('app.name') }}</span></a>
        ...
        <div id="navcol-1" class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('effects') }}">Effects</a></li>
            </ul>
        </div>
    </div>
</nav>
